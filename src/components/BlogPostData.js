const BlogPostData = [
  ...
  {
    title: "10 Scrimba Alternatives To Learn Programming",
    platform: "Codedamn",
    tags: ["programming", "online-courses"],
    link: "https://codedamn.com/news/programming/10-scrimba-alternatives",
  },
  {
  ...
  // Hashnode (change the links if the sub-domain has been changed or moved to a different one)
  {
